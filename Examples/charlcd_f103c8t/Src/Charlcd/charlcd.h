...
#define LCD_E        B, 7
#define LCD_E2       B, 4   /* If not used leave it that way */
#define LCD_RW       B, 6   /* If not used leave it that way */
#define LCD_RS       B, 5
#define LCD_D0       B, 8   /* If not used leave it that way */
#define LCD_D1       B, 9   /* If not used leave it that way */
#define LCD_D2       B, 10  /* If not used leave it that way */
#define LCD_D3       B, 11  /* If not used leave it that way */
#define LCD_D4       B, 12
#define LCD_D5       B, 13
#define LCD_D6       B, 14
#define LCD_D7       B, 15
